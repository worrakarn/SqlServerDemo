...
$databaseName = "my-db"
$connectionString = "Server=localhost,1433; Database=$databaseName; User Id=sa; Password=12345Abc%; TrustServerCertificate=True;"
$backupFolderPath = "/var/opt/mssql/backup"

# Inialize a database
$inputFile = "../init-db.sql"
Invoke-Sqlcmd `
  -ConnectionString "Server=localhost,1433; Database=master; User Id=sa; Password=12345Abc%; TrustServerCertificate=True;" `
  -InputFile $inputFile `
  -Verbose
